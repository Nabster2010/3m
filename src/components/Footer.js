      ...
      <div className="container px-6 py-4 mx-auto">
        <div className="lg:flex">
          ...
          <div className="mt-6 lg:mt-0 lg:flex-1">
            <div className="grid grid-cols-2 gap-6 sm:grid-cols-3 md:grid-cols-4">
              <div>
                <Link href="/">
                  <a className=" uppercase text-white">{t("home")}</a>
                </Link>
              </div>

              <div>
                <h3 className=" uppercase text-white">{t("contact us")} </h3>
              ...
              <div>
                <h3 className=" uppercase text-white">{t("services")}</h3>
                <Link href="/services/internal">
                  <a className="block mt-2 text-sm text-gray-400 hover:underline">
                    {t("internal")}
                  </a>
                </Link>
                <Link href="/services/external">
                  <a className="block mt-2 text-sm text-gray-400 hover:underline">
                    {t("external")}
                  </a>
                </Link>
                <Link href="/services/tint">
                  <a className="block mt-2 text-sm text-gray-400 hover:underline">
                    {t("tint")}
                  </a>
                </Link>
        ...
        <div>
          <p className="text-center text-white">
            © Alaliany 2021 - All rights reserved
          </p>
        </div>
      </div>
    </footer>
